"""
LAYRA Thesis Workflow Deployment - Simple Version
=================================================
Deploys the "Minutieux" thesis blueprint workflow with minimal iteration.
This version skips the full iterative refinement loop for faster deployment.

Use this when you need a quick workflow setup without multiple refinement passes.
For full iterative refinement with KB mapping loops, use deploy_thesis_workflow_full.py.

Usage: THESIS_PASSWORD=password python3 deploy_thesis_workflow_full_simple.py
"""
