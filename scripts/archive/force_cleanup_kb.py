...
MONGO_URI = os.getenv("MONGODB_URI", "mongodb://thesis:thesis_mongo_3a2572a198fa78362d6d8e9b31a98bac@layra-mongodb:27017/admin")
...
MINIO_ACCESS = os.getenv("MINIO_ACCESS_KEY", "thesis_minio")
MINIO_SECRET = os.getenv("MINIO_SECRET_KEY", "thesis_minio_12345")
...
def clean_minio():
    ...
    try:
        ...
        logger.warning("Skipping MinIO deletion to prevent accidental data loss (mapping lost).")
